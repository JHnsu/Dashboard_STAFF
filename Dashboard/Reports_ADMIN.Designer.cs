namespace Dashboard_STAFF
{
    partial class Reports_ADMIN
    {
        ...
        private void InitializeComponent()
        {
            ...
            button5.Font = new Font("Segoe UI Light", 7.8F, FontStyle.Regular, GraphicsUnit.Point, 0);
            ...
            panel6.Location = new Point(4, 498);
            ...
            button6.Margin = new Padding(0, 0, 20, 0);
            button6.Name = "button6";
            button6.Size = new Size(224, 32);
            button6.TabIndex = 1;
            button6.Text = " Edit Selected Account";
            button6.UseVisualStyleBackColor = false;
            button6.Click += button6_Click;
            button6.MouseEnter += button6_MouseHover;
            ...
            button7.Location = new Point(254, 10);
            button7.Margin = new Padding(0, 0, 20, 0);
            button7.Name = "button7";
            button7.Size = new Size(230, 32);
            button7.TabIndex = 2;
            button7.Text = "Delete Selected Account";
            button7.UseVisualStyleBackColor = false;
            button7.Click += button7_Click;
            button7.MouseEnter += button7_MouseHover;
            ...
            tableLayoutPanel1.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 28.7614288F));
            tableLayoutPanel1.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 71.23857F));
            tableLayoutPanel1.Controls.Add(button3, 1, 0);
            tableLayoutPanel1.Controls.Add(label3, 0, 2);
            tableLayoutPanel1.Controls.Add(label5, 0, 0);
            tableLayoutPanel1.Controls.Add(button2, 1, 1);
            tableLayoutPanel1.Controls.Add(orderPDF_button, 1, 2);
            ...
            orderPDF_button.TabIndex = 4;
            orderPDF_button.Text = "Export to PDF";
            orderPDF_button.UseVisualStyleBackColor = false;
            orderPDF_button.Click += orderPDF_button_Click;
            orderPDF_button.MouseEnter += orderPDF_button_MouseHover;
            orderPDF_button.MouseLeave += orderPDF_button_MouseLeave;
            orderPDF_button.MouseHover += orderPDF_button_MouseHover;
            // 
            // label4
            // 
